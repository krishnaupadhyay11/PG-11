    ...
    <div className="w-full h-full flex flex-col items-center">
      ...
      <div className="w-full flex flex-col items-center relative">
        <div className="absolute w-full bg-[#f0f0f0] flex flex-col items-center p-2">
          ...
          <p className="text-lg text-gray-900 text-center" data-aos="fade-up" data-aos-delay="100" data-aos-duration="1000">A look into facilities at your service in PG-11</p>
        </div>
      </div>
